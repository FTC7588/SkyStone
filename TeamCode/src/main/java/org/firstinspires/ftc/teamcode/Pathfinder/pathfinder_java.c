...
//#include "org_firstinspires_ftc_teamcode_Pathfinder_jaci_pathfinder_PathfinderJNI.h"
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_org_firstinspires_ftc_teamcode_Pathfinder_jaci_pathfinder_PathfinderJNI_generateTrajectory
    ...
    if (points == NULL) {
        ...
        return (jobjectArray)throwPathfinderException(env);
    }
    ...
    if (result < 0) {
        return (jobjectArray)throwGenerationException(env);
    }

    jclass cls = (*env)->FindClass(env, "org/firstinspires/ftc/teamcode/Pathfinder/jaci/pathfinder/Trajectory$Segment");
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_org_firstinspires_ftc_teamcode_Pathfinder_jaci_pathfinder_PathfinderJNI_modifyTrajectoryTank
    ...
    jclass cls = (*env)->FindClass(env, "Trajectory$Segment");
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_org_firstinspires_ftc_teamcode_Pathfinder_jaci_pathfinder_PathfinderJNI_modifyTrajectorySwerve
 ...
 */
JNIEXPORT void JNICALL Java_org_firstinspires_ftc_teamcode_Pathfinder_jaci_pathfinder_PathfinderJNI_trajectorySerialize
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_org_firstinspires_ftc_teamcode_Pathfinder_jaci_pathfinder_PathfinderJNI_trajectoryDeserialize
 ...
 * Signature: ([Ljaci/pathfinder/Trajectory/Segment;Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_org_firstinspires_ftc_teamcode_Pathfinder_jaci_pathfinder_PathfinderJNI_trajectorySerializeCSV
(JNIEnv *env, jclass thiscls, jobjectArray trajectory, jstring filename) {
pathfinder_clear_errors();
int length = (*env)->GetArrayLength(env, trajectory);
Segment *segs = malloc(length * sizeof(Segment));
 ...
 * Signature: (Ljava/lang/String;)[Ljaci/pathfinder/Trajectory/Segment;
 */
JNIEXPORT jobjectArray JNICALL Java_org_firstinspires_ftc_teamcode_Pathfinder_jaci_pathfinder_PathfinderJNI_trajectoryDeserializeCSV
        (JNIEnv *env, jclass thiscls, jstring filename) {
    pathfinder_clear_errors();
    const char *path;
    path = (*env)->GetStringUTFChars( env, filename, NULL ) ;
