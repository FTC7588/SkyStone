    ...
    private void calculate()
    {
        ...
        if (m_enabled)
        {
            ...
            if (m_continuous)
            {
                ...
                {
                    if (m_error > 0) {
                        double x = m_maximumInput - m_setpoint;
                        double y = -m_minimumInput - m_input;
                        m_error = y-x;
                        //m_error = m_maximumInput +1;
                    } else {
                        double x = -m_minimumInput - m_setpoint;
                        double y = m_maximumInput - m_input;
                        m_error = y-x;
                        //m_error = m_minimumInput - 1;
                    }
